...
if __name__ == '__main__':
    ...
    # a list witg image locations
    images = [os.path.join(data_path, "train_png", i + ".png") for i in images]

    # binary targets numpy array
    targets = df.target.values

    # fetch out model, we will try pretrained=True
    # and pretrained=False and see the difference
    ...
    # that allows you to do many differents types of image
    # augmentations. here, i am using it to only normalize 
    # notice always_apply=True. we always want to normalize
    ...
    # torch dataloader creates batchs of data
