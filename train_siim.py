...
from dataset_siim import SIIMDataset

# training csv file path
TRAINING_CSV = '/workspaces/AAAMLP/stage_2_train.csv'
...
def train(dataset, data_loader, model, criterion, optimizer):
    ...
    :param data_loader: torch dataset dataloader
    :param model: model
    ...
    for d in tk0:
        ...
        # you can simply call loss.backward()
        # and delete the following two lines of code
...
def evaluate(dataset, data_loader, model):
    ...
    # we need no_grad of torch. this save memory
    with torch.no_grad():
        for d in tk0:
            inputs = d["image"]
            targets = d["mask"]
...
if __name__ == '__main__':
    ...
    # function that can be used for normilizing images
    ...
    # wrap training dataset in torch DataLoader
    ...
    # augmentation is disabled for validation dataset
    ...
    # wrap validation dataset in torch DataLoader
    ...
    # code wont run without defining the criterion
    ...
    # if we hae more than one GPU, we can use both of them!
