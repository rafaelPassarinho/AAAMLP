...
class GreedyFeatureSelection:
    ...
    You will need to modify it wuite a bit to make it suitable
    for your dataset
    """
    def evaluate_score(self, X, y):
        """
        This function evaluates a model on data and returns
        ...
        This require only a few lines of change and has been
    ...
    def _feature_selection(self, X, y):
        ...
        while True:
            ...
            for feature in range(num_features):
                ...
                if feature in good_features:
                    continue
                # selected features are all good features + this feature
        ...
        # because we break the loop when we dont improve
        # and the last data point is the one that caused
        # the loop to break
...
if __name__ == "__main__":
    # generate binary classigication data
